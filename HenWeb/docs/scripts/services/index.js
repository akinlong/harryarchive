angular.module('timelineApp.services', [])
    .service('QiNiu', ['$rootScope', function ($rootScope) {
      ...
      var ak = 'vutUPMjwP2KrfBjwj1JsCiJtkdjBOzlYhbO8Dvug',
          sk = 'aNFPOEzClc-7_YBY-j-DR4M-yIDsFL9BK_ZbrrHq';
      var bucket = 'henrepository';
      ...
      this.uploader = Qiniu.uploader({
        ...
        domain: 'http://ocr44pi00.bkt.clouddn.com/',   //bucket 域名，下载资源时用到，**必需**
  ...
  // 野狗
    .service('WildDog', [function () {
      ...
      this.getDataRef = function (path) {
        ...
        _dataRefCache[path] = _dataRefCache[path] || new Wilddog('https://henlife.wilddogio.com/' + path);
